...
/***/ function(module, exports, __webpack_require__) {
	...
	var Answer = function Answer() {
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { placeholder: 'Insert answer', className: 'form-control' })
	    );
	};
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement('input', { className: 'form-control', placeholder: placeholder, ref: function ref(_ref) {
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'button',
	                            { className: 'btn btn-primary btn-small', onClick: this.onAddAnswer, style: { marginRight: 5 } },
	                            'Add Answer'
	                        ),
	                        _react2.default.createElement(
	                            'button',
	                        ...
	                        this.state.answer && _react2.default.createElement(Answer, null)
	                    )
	                )
	            );
	        }
	...
	var ConversationForm = function (_React$Component2) {
	    _inherits(ConversationForm, _React$Component2);
	
	    function ConversationForm(props) {
	        _classCallCheck(this, ConversationForm);
	
	        var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(ConversationForm).call(this, props));
	
	        _this3.onNewMessageClick = function () {
	            var newMessage = convFactory.createMessage();
	
	            var conv = _this3.state.conversation.set('messages', _this3.state.conversation.get('messages').push(newMessage));
	
	            _this3.setState({ conversation: conv });
	        };
	
	        _this3.onDeleteMessage = function (msgIndex) {
	            var messages = _this3.state.conversation.get('messages');
	            var newMessages = messages.filter(function (msg, index) {
	                return msgIndex !== index;
	            });
	
	            _this3.setState({
	                conversation: _this3.state.conversation.set('messages', newMessages)
	            });
	        };
	
	        _this3.onUpdateMessage = function (msgIndex, data) {
	            var messages = _this3.state.conversation.get('messages');
	                ...
	                messages.map(function (msg, i) {
	                    return _react2.default.createElement(Message, {
	                        ...
	                        onDelete: function onDelete() {
	                            return _this4.onDeleteMessage(i);
	                        },
	                        updateMessage: function updateMessage(text) {
	                            return _this4.onUpdateMessage(i, text);
	                        }
	                    });
	                })
	            );
